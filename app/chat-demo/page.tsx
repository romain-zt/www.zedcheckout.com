      ...
      <div className="container mx-auto px-4 py-20">
        <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="flex-1">
                ...
                <ol className="space-y-2 text-white/80">
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>Discutez naturellement avec l'AI - posez des questions, partagez vos infos</span>
                  </li>
                  <li className="flex items-start gap-2">
                    ...
                    <span>L'AI répond à vos questions et capture vos infos naturellement</span>
                  </li>
                  <li className="flex items-start gap-2">
          ...
          <div className="mt-12 flex flex-wrap justify-center gap-4">
            ...
            <div className="px-4 py-2 bg-gradient-to-r from-[#E88B7A]/20 to-[#FFC9B9]/20 backdrop-blur-sm rounded-full border border-[#E88B7A]/30 text-sm text-[#1E2A47] font-semibold">
              🤖 AI-Powered (Claude)
            </div>
          </div>
        </div>
