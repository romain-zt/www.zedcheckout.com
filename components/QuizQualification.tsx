...
const quizQuestions: Question[] = [
  ...
  },
  {
    ...
    options: [
      ...
      'Hotjar / Clarity',
      'Stripe Dashboard',
      'Les analytics de votre plateforme',
      'Aucun de ces outils',
      'Je ne sais pas',
    ],
    required: true,
  ...
  },
  {
    id: 'q3',
    type: 'multiple',
    title: 'À quelle fréquence modifiez-vous votre processus d\'achat pour améliorer vos conversions ?',
    options: [
      'Régulièrement (itération rapide tous les mois)',
      '1 fois par an ou moins',
      'Jamais, car je n\'y suis pas parvenu',
      'Jamais, car je ne m\'y suis jamais intéressé',
    ],
    required: true,
  },
  {
  ...
  },
  {
    id: 'q6',
    type: 'checkbox',
    title: 'Avez-vous identifié des points de friction dans votre processus d\'achat actuel ?',
    options: [
  ...
  },
  {
    id: 'q7',
    type: 'checkbox',
    title: 'Votre processus d\'achat inclut-il des spécificités complexes ?',
    options: [
