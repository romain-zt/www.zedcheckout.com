...
export function BookingConfirmationEmail(props: BookingConfirmationProps) {
  ...
  const t = getConfirmationCopy(locale);
...
export function getConfirmationSubject(serviceName: string, locale: 'fr' | 'en') {
  return getConfirmationCopy(locale).subject(serviceName);
}
